  ...
  return (
    <main className="flex-1 p-6 md:p-margin-page max-w-container-max mx-auto w-full opacity-0" ref={mainRef}>
      ...
      <div className="flex items-center gap-4 mb-stack-lg">
        ...
        <div>
          <h2 className="font-heading text-headline-lg text-text-base mb-1">Create Coupon</h2>
          <p className="font-body-md text-body-md text-text-muted">Configure a new promotional discount code.</p>
        </div>
      </div>
