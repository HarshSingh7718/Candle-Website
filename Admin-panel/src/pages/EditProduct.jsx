...
const EditProduct = () => {
  ...
  useEffect(() => {
    ...
    if (product) {
      ...
      const initialPreviews = [product.image || null, null, null, null];
  ...
  return (
    <main ref={mainRef} className="p-gutter md:p-margin-page max-w-container-max mx-auto w-full">
      <div className="mb-stack-lg">
        ...
        <h2 className="font-heading text-headline-xl text-on-surface mb-2">Edit Product</h2>
        <p className="font-body-lg text-secondary">Update details for this artisanal entry</p>
      </div>
