  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          ref={addToRefs}
          className="flex items-center gap-3 px-4 py-2.5 text-stone-500 dark:text-stone-400 hover:text-stone-800 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-900 transition-all duration-200 active:scale-95 transform transition-transform"
          href="#"
        >
