  ...
  return (
    <>
      <section
        ref={aboutRef}
        id="about"
        className="about container py-[8%] mx-auto section-container gap-14 px-4"
      >
        <div
          className="about-image  rounded-sm w-full lg:w-1/2 max-w-full
        ...
        >
          ...
          <img
            src={aboutMainImg}
            alt="Our Story"
            className="about w-full h-auto object-cover rounded-sm"
            loading="lazy"
          />
        </div>
        ...
        <div className="about-content w-full lg:w-1/2">
          ...
          <p className="pera-text">
            Founded on the belief that scent is a bridge to memory and
            tranquility, Naisha Creations brings you candles that are more than
            just wax and wick. Every piece is a story of craft, poured by hand
