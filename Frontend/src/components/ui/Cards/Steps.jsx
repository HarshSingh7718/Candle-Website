...
const CANDLE_STEPS = [
  {
    ...
    description:
      "Browse our curated library of premium essential oils and hand-pick the fragrance profile that matches your mood.",
  },
  {
    number: "02",
    title: "Vessel Design",
    description:
      "Select from our range of handcrafted glass or ceramic vessels to perfectly complement your home interior.",
  },
  {
    number: "03",
    title: "Artisan Pouring",
    description:
      "Our experts hand-pour natural soy wax at precise temperatures to ensure a clean, long-lasting, and even burn.",
  },
  {
    number: "04",
    title: "Enjoying Glow",
    description:
      "Light your custom candle, sit back, and transform your space with a warm glow and artisanal aroma.",
  },
];
...
const Steps = () => {
  ...
  return (
    <div
      className="min-h-screen bg-light-yellow font-sans selection:bg-stone-200"
      ref={containerRef}
    >
