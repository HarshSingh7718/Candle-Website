...
const SignIn = () => {
    ...
    const { setUser } = useStore(); // To update global user state
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // Path from app.js: /api/auth/user/login
            ...
            if (data.success) {
                ...
                setUser(data.user); // Store user info in global context
                    ...
                    <form className='space-y-4' onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-1.5 text-left">
                            <div className="flex justify-between items-center">
                                ...
                                <Link to="/forgot-password" university-link className="text-[13px] font-bold text-[#ea580c] hover:underline">
                                    Forgot password?
                                </Link>
                            </div>
