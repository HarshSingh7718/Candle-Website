            ...
            <div className="w-full lg:w-[65%] h-full flex flex-col justify-center items-center px-6 py-12 overflow-y-auto bg-[#fafafa]">
                <div className="w-full max-w-[420px]">
                    ...
                    <form className='space-y-6' onSubmit={handleSendOtp}>
                        <div className="space-y-1.5 text-left">
                            ...
                            <div className="relative flex items-center">
                                <div className="absolute left-4 text-[15px] text-gray-500 font-medium">+91</div>
                                <input
                                    type="tel"
                        ...
                        <button
                            type="submit"
                            disabled={isSendingOtp}
                            className='w-full py-3 mt-6 bg-[#ea580c] hover:bg-[#c2410c] text-white font-bold rounded-[20px] transition-all shadow-[0_4px_14px_0_rgba(234,88,12,0.39)] text-[15px] cursor-pointer disabled:bg-gray-400'
                        >
                    ...
                    <div className="text-center mt-8 text-[14px] text-gray-500">
                        ...
                        <Link to="/signin" className="text-[#ea580c] font-bold hover:underline">Sign in</Link>
                    </div>
                </div>
            </div>
        </div>
