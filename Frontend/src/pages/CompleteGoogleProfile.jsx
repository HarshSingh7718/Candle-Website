              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <form className="space-y-4" onSubmit={handleSendOtp}>
                  ...
                  <button
                    ...
                    type="submit"
                    className="w-full py-3 mt-4 bg-coffee-600 hover:bg-coffee-700 text-white font-bold rounded-[20px] transition-all shadow-[0_4px_14px_0_rgba(234,88,12,0.39)] text-[14px] cursor-pointer disabled:bg-gray-400"
                  >
              ...
              <div className="animate-in fade-in slide-in-from-right-8 duration-500">
                ...
                <form className="space-y-8" onSubmit={handleVerify}>
                  ...
                  <button
                    ...
                    type="submit"
                    className="w-full py-3 bg-coffee-600 hover:bg-coffee-700 text-white font-bold rounded-[20px] transition-all shadow-[0_4px_14px_0_rgba(234,88,12,0.39)] text-[15px] cursor-pointer disabled:bg-gray-400"
                  >
